...
Este circuito está diseñado para convertir señales donde el "1" es un voltaje de entre 3V a 24V a otro voltaje distinto en el mismo rango\n\nTiene aislamiento galvanico\nLa corriente de entrada es muy baja\nLa corriente de salida es suficiente para activar un relé\nLa salida es por colector abierto por lo que es un sumidero de corriente, no está ligado a un voltaje concreto
Text Notes 850  4050 0    50   ~ 0
Este lado puede ser un microcontrolador generando 3.3 o 5V\nPero también puede ser 24V pasando o no por un botón 
Text Notes 4400 7350 0    50   ~ 0
Estas resistencias deben dimensionarse para 10mA\n2k2 para 24V\n470 para 3.3 ó 5V\n
Text Notes 7900 5400 0    50   ~ 0
Este lado son sumideros de corriente\nActivar Reles:\nFuente del mismo voltaje que la bobina del relé se conecta:\n- Vcc a uno de los bornes del relé\n- GND al GNDD de esta tarjeta\nRelé:\n- Vcc de la fuente\n- Sumidero de corriente de esta tarjeta\n\nnota: puede que para corrientes muy altas de activación de relé\n (hasta 50mA debería ser posible) se deba cambiar la resisistencia\n RA1-RA4 también a valores más bajos.\n\nEsta tarjeta:\n- 3V3 se deja sin conectar\n-GNDD a masa de la fuente\n- cada sumidero a un relé\n- RB1 a RB4 son cortocircuitos\n\nCaso conectar a microcontrolador\n\nEsta tarjeta\n3V3 a la tensión del "1" del microcontrolador que será 3.3V ó 5V\nGNDD a la masa del microcontrolador\nRB1 a RB4 son resistencias pull-down de 2k2 ohm\ncada sumidero a cada linea de entrada digital del microcontrolador
$EndSCHEMATC
